...
values
  ...
  ('create-transaction', 'Registrar movimientos', 'Para registrar un movimiento, entrá en Transacciones, elegí ingreso, gasto o inversión y completá monto, categoría, fecha y descripción. También podés indicar medio de pago y si el gasto es reembolsable.', array['registrar','crear','cargar','gasto','ingreso','inversion','movimiento'], 'faq', 3),
  ('categories', 'Categorías', 'Podés crear, editar y eliminar categorías propias, asignarles un color y separarlas por tipo. No se permite repetir el mismo nombre y tipo.', array['categoria','categorias','color','duplicada','renombrar'], 'faq', 4),
  ...
  ('projections', 'Proyecciones', 'En Proyección podés planear ingresos y gastos futuros, marcarlos como pagados o cobrados y convertirlos en transacciones reales.', array['proyeccion','futuro','recurrente','pendiente','convertir'], 'faq', 6),
  ...
  ('telegram', 'Telegram', 'Desde Configuración generás un código para vincular tu cuenta con el bot de Telegram. Después podés registrar uno o varios movimientos por chat.', array['telegram','bot','chat','vincular','codigo'], 'faq', 8),
